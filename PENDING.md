# my_career — OPEN ITEMS

Track of work in progress, decisions pending, and things to circle back to. Timestamped for clarity.
...
- [ ] **Document as asset** — Create clean portfolio description (if leveraging for FP&A context)
- [ ] **Continue development** — Lower priority; maintain but don't actively expand during career transition
